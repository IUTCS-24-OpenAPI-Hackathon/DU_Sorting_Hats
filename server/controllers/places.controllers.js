...
module.exports = {
  findNearbyPlaces: (req, res) => {
    ...
    const url = `https://api.geoapify.com/v2/places?categories=public_transport.subway&filter=circle:-0.07071648508463113,51.50848194136378,1000&bias=proximity:-0.07071648508463113,51.50848194136378&limit=20&apiKey=${API_Key}`;
